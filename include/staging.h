...
typedef struct
{
    ...
    unsigned char hash[HEX_STR_SIZE]; // SHA-256 converted to hex string
...
vcs_error_t staging_compute_blob_hash(const char *path, char *hash); // Compute hash for a file
